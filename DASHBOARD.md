...
| Alloc-fail/UAF security sweep (praetor directive m0126) — Phase 1 findings | Farragut (m0126 directive) / Intrepid (dix/+os/) / Constellation (Xext+mi+miext, hw/xfree86, intel+amdgpu, nouveau+vmware+qxl, input drivers) | 2026-07-07 | [`dashboard/themes/alloc-fail-uaf-sweep-m0126-phase1-dix-os.md`](dashboard/themes/alloc-fail-uaf-sweep-m0126-phase1-dix-os.md) |
