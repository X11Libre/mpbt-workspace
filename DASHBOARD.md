...
| DESQview/X (X11R5 DOS server, Quarterdeck, early 90s) under QEMU — vintage interop test for go-x11proto/pyxtest | Phase 1 (proof-of-life networking) DONE 2026-07-06 — FreeDOS boots, mTCP+NE2000 ping works. Starting Phase 2 (DESQview/X media)… | [`dashboard/themes/desqview-x-under-qemu-vintage-interop-test-for-go-x11proto-p.md`](dashboard/themes/desqview-x-under-qemu-vintage-interop-test-for-go-x11proto-p.md) |
