...
| go-x11proto library + tools + Debian packaging (separate repo/project) | **v0.0.7 released**; new `tk/term` terminal-emulator widget built 2026-07-06 (Endeavour), not yet merged | [`dashboard/themes/go-x11proto-library-tools-debian-packaging.md`](dashboard/themes/go-x11proto-library-tools-debian-packaging.md) |
...
| xserver-build-freebsd CI lane currently red fleet-wide — NOT a transient flake, a real OS/package version-skew that won't self-clear on retry | Done, 2026-07-06 (Potemkin) — PR #3259 merged-ready, CI fully green. | [`dashboard/themes/xserver-build-freebsd-ci-lane-currently-red-fleet-wide-not-a.md`](dashboard/themes/xserver-build-freebsd-ci-lane-currently-red-fleet-wide-not-a.md) |
