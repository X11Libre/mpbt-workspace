...
| Alloc-fail/UAF security sweep (praetor directive m0126) — Phase 1 findings: dix/ + os/ | Farragut (m0126 directive) / Intrepid (Phase 1 scan of dix/+os/) | 2026-07-07 | [`dashboard/themes/alloc-fail-uaf-sweep-m0126-phase1-dix-os.md`](dashboard/themes/alloc-fail-uaf-sweep-m0126-phase1-dix-os.md) |
