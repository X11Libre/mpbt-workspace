...
| Dashboard access fully encapsulated via starfleetctl — no more direct file access by agents | CLI-only guidance landed 2026-07-07 (Constellation, m0123). Open questions resolved, enforcement deliberately deferred (convention-only for… | [`dashboard/themes/dashboard-access-fully-encapsulated-via-starfleetctl-no-direct.md`](dashboard/themes/dashboard-access-fully-encapsulated-via-starfleetctl-no-direct.md) |
...
| Driver repos — cross-repo PR/issue dashboard (xserver issue #3280) | Built + live, 2026-07-07 (Agamemnon) — needs periodic refresh | [`dashboard/themes/driver-repos-cross-repo-pr-issue-dashboard.md`](dashboard/themes/driver-repos-cross-repo-pr-issue-dashboard.md) |
...
| go-x11proto library + tools + Debian packaging (separate repo/project) | v0.0.7 released on master | [`dashboard/themes/go-x11proto-library-tools-debian-packaging.md`](dashboard/themes/go-x11proto-library-tools-debian-packaging.md) |
...
| Hurd CI job (xserver-build-hurd) can hang with no timeout | Claimed by Potemkin, 2026-07-06 — adding timeout-minutes. | [`dashboard/themes/hurd-ci-job-can-hang-with-no-timeout.md`](dashboard/themes/hurd-ci-job-can-hang-with-no-timeout.md) |
...
| Prepare starfleet fleet-coordination tooling for master (wip/starfleet-upstream) | Branch + draft PR created 2026-07-06 (Enterprise, praetor request) — empty scaffold, content prep not started yet. | [`dashboard/themes/starfleet-upstream-master-prep.md`](dashboard/themes/starfleet-upstream-master-prep.md) |
...
| Dedicated ship for local UI automation (special privileges?) | praetor, 2026-07-07 | 2026-07-07 | [`dashboard/themes/dedicated-ship-for-local-ui-automation-special-privileges.md`](dashboard/themes/dedicated-ship-for-local-ui-automation-special-privileges.md) |
...
| xdotool getactivewindow windowkill in go-x11proto terminal-demo testing killed the whole shared lxterminal (all ships) — 2026-07-06 | Enterprise, 2026-07-06, root-caused from transcript after the fleet-wide crash | 2026-07-06 | [`dashboard/themes/xdotool-windowkill-in-terminal-demo-testing-killed-the-shared-lxterminal.md`](dashboard/themes/xdotool-windowkill-in-terminal-demo-testing-killed-the-shared-lxterminal.md) |
...
| RESOLVED — xx-make-pr.sh leaked [PR #NNNN]/PR: markers onto the PR branch (not just the incubator) | `AGENTS.md` "PR workflow" | 2026 (found via PR #3162) | [`dashboard/themes/xx-make-pr-sh-leaks-pr-nnnn-pr-markers-onto-the-pr-branch.md`](dashboard/themes/xx-make-pr-sh-leaks-pr-nnnn-pr-markers-onto-the-pr-branch.md) |
