...
| Dashboard access fully encapsulated via starfleetctl — no more direct file access by agents | Directive issued by praetor, 2026-07-07 — unclaimed, not started. | [`dashboard/themes/dashboard-access-fully-encapsulated-via-starfleetctl-no-direct.md`](dashboard/themes/dashboard-access-fully-encapsulated-via-starfleetctl-no-direct.md) |
