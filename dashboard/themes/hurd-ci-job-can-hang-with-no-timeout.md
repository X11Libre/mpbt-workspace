...
category: active
status: "**Claimed by Potemkin, 2026-07-06 — adding timeout-minutes.**"
doc_ref: "run 28600347199 / job 84806756748 (PR #3231), cancelled by praetor after ~33m; `.github/scripts/hurd/run-vm-build.sh` (QEMU), see `AGENTS.md` \"Hurd CI\""
