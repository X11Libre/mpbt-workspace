---
name: licensing
description: "XLibre licensing policy for new files — which license to apply (xserver/driver deliverables vs. non-deliverable tooling) and the explicitly deferred retroactive relicense TODO. Use when creating any new file in xserver/driver clones or workspace scripts and need the correct SPDX license header."
---
