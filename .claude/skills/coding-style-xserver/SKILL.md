---
name: coding-style-xserver
description: "Xlibre coding style for the X server source. Applies only to new code — not retroactively to existing code unless a styling cleanup is explicitly requested. Use when writing or reviewing new/modified code in the xserver source tree."
---
