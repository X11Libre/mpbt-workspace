...
[ ] noch einige xserver spezifischen dinge entfernen
[ ] _WORK_
[ ] mk-agent-clone sollte nicht nur für releases sondern beliebige repos funktionieren
[ ] starfleet -> env variables umbenennen
[ ] messages --> im subdir seen = acked
[ ] skill für messaging schärfen
[ ] fragments/starfleet vs fragments/starfleet-skills --> consolidieren ?
[ ] skills: nur die für den agent benötigten dinge rein, alles andere ist user-doku
[ ] skills: sind die genannten limitations noch aktuell ?
[ ] bug (2026-07-28): agents greifen noch auf rohe dashboard-files direkt zu --> fehlen evtl. passende frontend-commands oder skills noch nicht korrekt ?
[ ] dashboard-einträge: ist das slug-feld dort wirklich nötig ? (oder reicht dort schlicht der filename ?)
