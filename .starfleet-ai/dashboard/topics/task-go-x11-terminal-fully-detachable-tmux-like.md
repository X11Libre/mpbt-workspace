...
**Status:** Teilweise implementiert in `demo/terminal-aa-detach/` (go-x11proto Repo). Funktioniert aber noch nicht stabil — geht nur kurzzeitig, bei mehrmaligem attach/detach-Breaks bricht es zusammen.
