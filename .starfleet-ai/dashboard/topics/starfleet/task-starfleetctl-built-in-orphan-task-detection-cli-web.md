...
**Progress (Voyager 2026-09-07):** Implementierung + Tests fertig & gruen. CLI `task orphans [--json]` (FindOrphans in internal/task), Web-API GET /api/tasks/orphans, Web-UI-Button "Orphans" auf Tasks-Seite mit One-Click-Reassign (__auto__ -> Flagschiff-Delegation oder explizites Idle-Schiff-Dropdown). Unit-Tests internal/task + internal/web gruen, `make all` gruen. Skill-Reference + SKILL.md aktualisiert. **Noch nicht committet/deployed:** warte auf Enterprises "master sauber"-Push (m97637/m97639 — sie committet parallel die unbelegten starfleetctl-Features). Danach: nur Orphan-Files committen, make + starfleet-bootstrap, Report an Enterprise.

- 2026-09-07T11:07:46Z Voyager: completed
