...
enough of the tree is covered — coordinate via comms before starting a fix so two ships don't
duplicate.
...
**Still unscanned** — free ships should pick one and claim it here (or via comms) before
...
- Item 6 (`DeepCopyPointerClasses` wrong/late NULL check on touch alloc) → [PR
#3275](https://github.com/X11Libre/xserver/pull/3275)
